          ...
          <Card className="w-full max-w-2xl shadow-2xl border-0">
            <CardContent className="p-12 text-center">
              ...
              <div className="bg-charity-bg-calm border-2 border-charity-medium rounded-xl p-6 mb-8">
                ...
                <a
                  href="https://wa.me/966920011240"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-3xl font-bold text-charity-dark hover:text-green-600 transition-colors"
                  dir="ltr"
                >
                  <svg
      ...
      >
        <div className="max-w-3xl mx-auto">
          <div className="mb-5 flex justify-between items-center">
            <div className="relative h-14 w-[200px] sm:h-16 sm:w-[240px] md:h-18 md:w-[280px]">
              <Image
            ...
            <div className="text-sm text-gray-600">
              <span className="block text-xs mb-1">للاستفسارات أو المساعدة</span>
              <a
                href="https://wa.me/966920011240"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 font-bold text-gray-800 hover:text-green-600 transition-colors"
                dir="ltr"
              >
